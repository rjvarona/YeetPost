#pragma checksum "R:\GitHubYeetPost\YeetPostV1_4\YeetPostV1_4\Views\Shared\_YeetPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c4797dafcf60b727ed24cb96df47d6a12305e6be"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c4797dafcf60b727ed24cb96df47d6a12305e6be", @"/Views/Shared/_YeetPartial.cshtml")]
            ...
            <v-card-title>
                ...
                <v-list-item-content>
                    <v-list-item-title> &nbsp; {{yeet.location}}</v-list-item-title>
                        ...
                        <v-dialog v-if=""yeet.isMine == true"" v-model=""yeet.deleteModal"" persiste");
            WriteLiteral(@"nt max-width=""290"">
                                ...
                                <div>
                                    ...
                                    <v-card-actions>
                                        ...
                                        <v-btn color=""green darken-1"" text
                                               v-on:click=""deleteYeet(yeet.yeetID, yeet.");
            WriteLiteral(@"location)"">Yes</v-btn>
                                    </v-card-actions>
                                </div>
                                <div>
                        ...
                        <v-dialog v-model=""yeet.modal"" persistent max-width=""290"" v-if=""yeet.iFlagged == false && yeet.isMine == false"">
                            <template v-slot:activator=""{ on }"">
                                <v-list-item-content>
                                    ...
                                    <v-icon class=""mr-1"" color=""");
            WriteLiteral(@"white"" v-on=""on"">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; mdi-flag</v-icon>
                                </v-list-item-content>
                            </template>
                            <v-card>
                                ...
                                <v-row>
                                    ...
                                    <v-col cols=""12"">
                                        <v-card-text style=""font-size: 32px;text-align: ce");
            WriteLiteral(@"nter;""
