#pragma checksum "R:\GitHubYeetPost\YeetPostV1_4\YeetPostV1_4\Views\Shared\_YeetPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5a98d0d4cd817d63e18d12492a31d7deb1170241"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5a98d0d4cd817d63e18d12492a31d7deb1170241", @"/Views/Shared/_YeetPartial.cshtml")]
    ...
    <v-card class=""mx-auto""
        ...
        <div >
            <v-card-title>
                ...
                <div v-if=""yeet.isMine == true"">
                    ");
            WriteLiteral(@"<v-dialog  v-model=""yeet.deleteModal"" persistent max-width=""290"">
                        ...
                        <v-card>
                            <div>
                                <v-card-title class=""headline"" style=""text-align: center;"">Are you sure you want to deYeet Yeet {{yeet.yeetID}}</v-card-title>
                                <v-card-actions>
                                    <v-spacer></v-spacer>
                                    <v-btn color=""green darken-1"" text v-on:click=""yeet.deleteModal = false"">Close</v-btn>
                                    <v-btn color=""green darken-1"" text
                                           v-on:click=""deleteYeet(yeet.yeetID)"">Yes</v-btn");
            WriteLiteral(@">
                                </v-card-actions>
                            </div>
                            <div>
        ...
        <v-card-actions>
            ...
            WriteLiteral(">{{yeet.totalLikes}}</span>\n\n                </v-row>\n            </v-list-item>\n        </v-card-actions>\n\n    </v-card>\n        <br />\n    </v-app>\n\n");
        }
